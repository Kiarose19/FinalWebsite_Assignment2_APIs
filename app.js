...
function GoToDataArtPage(){
    window.location.replace("https://kiarose19.github.io/FinalWebsite_APIs_Assignment2/data-art.html");
}
...
function GoToDataVisPage(){
    window.location.replace("https://kiarose19.github.io/FinalWebsite_APIs_Assignment2/data-vis.html");
}
...
function GoToDesignPage(){
    window.location.replace("https://kiarose19.github.io/FinalWebsite_APIs_Assignment2/designs.html");
}
...
function GoToBlogsPage(){
    window.location.replace("https://kiarose19.github.io/FinalWebsite_APIs_Assignment2/blogs.html");
}
